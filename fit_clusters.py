...
#%% Packages to import
from utils_func import load_obj, save_obj, f_exist, concat_alignment_data, folder_create
import numpy as np
np.seterr(divide='ignore', invalid='ignore') # We will devide by 0 at some point, which is not a error
...
if __name__ == "__main__":
    ...
    m_k, W_k, v_k, Nk, r_nk, alpha_k, beta_k = \
        post_process_parameters(res.threshold, thetadata, m_k, W_k, v_k, Nk, r_nk, 
                                alpha_k, beta_k, res.alpha0, res.beta0, res.v0, res.forcezeromean)
